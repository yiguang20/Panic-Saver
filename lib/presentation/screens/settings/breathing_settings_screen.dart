...
/// Breathing settings sub-screen
class BreathingSettingsScreen extends StatelessWidget {
  const BreathingSettingsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(l10n.breathingSettingsTitle),
      ),
      body: SafeArea(
        child: Consumer<SettingsProvider>(
          builder: (context, settings, _) {
            return ListView(
              ...
              children: [
                // Breathing Presets
                _buildSectionHeader(context, l10n.breathingPresetsTitle),
                ...
                // Custom Breathing
                _buildSectionHeader(context, l10n.customBreathingTitle),
                const SizedBox(height: AppDimensions.spacingM),
                ...
                // Current Settings
                _buildSectionHeader(context, l10n.currentSettingsTitle),
                const SizedBox(height: AppDimensions.spacingM),
